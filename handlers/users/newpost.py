...
from keyboards.default.lessons import lesson


@dp.callback_query_handler(text="check_subs")
async def lesson(message: types.Message):
    await message.answer("Fanni tanlang",reply_markup=lesson)


@dp.message_handler(text="Matematika")
async def math(message: Message):
    await message.answer("Matematika o'qituvchisi: @sodiqdev")


@dp.message_handler(text="Fizika")
async def fizika(message: Message):
    await message.answer("Fizika o'qituvchisi: @sodiqdev")
